...
def get_pets_datasets(train_transform, test_transform, train_classes=range(19), prop_train_labels=0.8,
    ...
    whole_training_set = OxfordIIITPet(root=pets_root, transform=train_transform, split='trainval',
                                       download=True)  # len = 3680
    ...
    test_dataset = OxfordIIITPet(root=pets_root, transform=test_transform, split='test', download=True)
